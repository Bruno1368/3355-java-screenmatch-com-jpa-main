...
public interface SerieRepository extends JpaRepository<Serie, Long> {
    ...
    @Query("SELECT s FROM Serie s WHERE s.totalTemporadas <= :temporada AND s.avaliacao >= :avaliacao") //jpql, o : antes de temporada é pra indicar que é o parametro
    ...
    List<Episodio> episodioPorData(Serie serie, int anoLancamento);
}
